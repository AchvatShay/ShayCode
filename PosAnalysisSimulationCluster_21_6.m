...
%                 synDistributionDepth3Temp(eventsList.clusterByH(i_e), isclusterd) = synDistributionDepth3Temp(eventsList.clusterByH(i_e), isclusterd) + 1;
%             end
%             
...
%             synIndexNode(end+1) = nodeIndex1;
        ...
        AllResults.totalSyn.(sprintf('c%d', eventsList.clusterByH(i_e)))(end+1) = totalSAll;
        ...
        gNMDA(eventsList.clusterByH(i_e)) = gNMDA(eventsList.clusterByH(i_e)) + mean(tempR, 'omitnan');
        
        AllResults.gNMDA.(sprintf('c%d', eventsList.clusterByH(i_e)))(end+1) = mean(tempR, 'omitnan');
        ...
        if ~isempty(Ap1_l_s)
            ...
            AllResults.somaV.(sprintf('c%d', eventsList.clusterByH(i_e)))(end+1) = max(load_v.V(soma, :));
        ...
        AllResults.nexusV.(sprintf('c%d', eventsList.clusterByH(i_e)))(end+1) = max([max(load_v.V(ht1, :)), max(load_v.V(ht2, :))]);
...
%              end          
         ...
         AllResults.nmdaBranches.(sprintf('c%d', eventsList.clusterByH(i_e)))(end+1) = sumNMDASpike;
