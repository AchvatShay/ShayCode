function SimulationResultsToTPANew_1508(simFolderResults, outputpath, ExpName, type,  dosaturator, saturatorValue)
    if strcmp(type, 'V')
        mkdir([outputpath, '\V\', ExpName, '_SR50']);
        SimulationResultsToTPA_V([simFolderResults, ExpName], [outputpath, '\V\', ExpName, '_SR50']);
    elseif strcmp(type, 'Cai_1508')        
        mkdir([outputpath, '\Cai_1508\', ExpName, '_', num2str(dosaturator),'_', num2str(saturatorValue), '_SR50']);
        SimulationResultsToTPA_Cai([simFolderResults, ExpName], [outputpath, '\Cai_1508\', ExpName, '_', num2str(dosaturator),'_', num2str(saturatorValue), '_SR50'],  dosaturator, saturatorValue);
    elseif strcmp(type, 'F_1508') 
        mkdir([outputpath, '\F_1508\', ExpName, '_SR50']);
        SimulationResultsToTPA_FNew([simFolderResults, ExpName], [outputpath, '\F_1508\', ExpName, '_SR50']);
   end
end
