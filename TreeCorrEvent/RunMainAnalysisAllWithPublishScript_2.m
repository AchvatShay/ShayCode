...
globalParameters.AnimalName = 'CT67';
globalParameters.DateAnimal = '22_08_26 HR tuft control';
globalParameters.swcFile = 'swcFiles\neuron_1.swc';
globalParameters.neuronNumberName = 'N1';
globalParameters.RunnerDate = '20.9.22';
globalParameters.RunnerNumber = 'Run1_BySuccess';
...
globalParameters.eventsDetectionFolder = fullfile(globalParameters.MainFolder, globalParameters.AnimalName, ...
    ...
    globalParameters.RunnerDate, 'EventsDetection');
...
globalParameters.excludeRoi = [18 19 29 30 32 39];
