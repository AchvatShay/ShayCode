function [roiActivityDistanceMatrixByH, roiActivityDistanceMatrixByPrecantage] = calcROIDistanceInActivity_WindowEventPearson_V3(roiActivity, roiActivityNames, selectedROI, all_event_table, typeCom, clusterNum)
