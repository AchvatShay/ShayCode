...
function [y_den, psnr_val, ssim_val] = external_NLM(y, z, sigma, data)

%external_NLM: single image non-local means denoising using a targeted external database
%Input:
